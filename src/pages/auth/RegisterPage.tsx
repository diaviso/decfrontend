      ...
      <Card className="border-0 shadow-2xl bg-white/95 dark:bg-[#141F1A]/95 backdrop-blur-xl overflow-hidden">
        ...
        <CardHeader className="space-y-1 pb-4 pt-6">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2.5 rounded-xl bg-[#F5A623]/10 dark:bg-[#FFBE4D]/20">
              <UserPlus className="h-5 w-5 text-[#F5A623] dark:text-[#FFBE4D]" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="firstName" className="text-[#1A2E23] dark:text-[#A8C4B4] font-medium">
                  Prénom
                </Label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#5A7265] dark:text-[#8BA898]" />
                  <Input
                    id="firstName"
                    type="text"
                    placeholder="Jean"
              ...
              <div className="space-y-2">
                <Label htmlFor="lastName" className="text-[#1A2E23] dark:text-[#A8C4B4] font-medium">
                  Nom
                </Label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#5A7265] dark:text-[#8BA898]" />
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-[#5A7265] dark:text-[#8BA898]">
