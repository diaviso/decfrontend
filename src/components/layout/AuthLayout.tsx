...
export function AuthLayout() {
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Branding with DEC Learning colors */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        {/* Background gradient with brand colors */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#1B5E3D] via-[#144832] to-[#0D3321]" />
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          >
            ...
            <h1 className="text-4xl font-bold mb-4 tracking-tight">DEC Learning</h1>
            <p className="text-xl text-white/80 max-w-md leading-relaxed">
              Préparez votre Diplôme d'Expertise Comptable avec une plateforme moderne et interactive
            </p>
          </motion.div>
          ...
          >
            Rejoignez la communauté des futurs experts-comptables
          </motion.p>
        </div>
      </div>
